...
import com.springmvc.validator.FileNotNull;
import com.springmvc.validator.ValidImage;
...
public class CreateDTO {
	...
	private Float price;
	@FileNotNull(message = "File image is required.")
	@ValidImage(type = {"image/jpeg","image/png","image/jpg"}, message = "File image format is incorrect.")
	...
	public CreateDTO(Integer productId, @NotEmpty(message = "ProductName is required.") String productName,
